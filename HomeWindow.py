...
from PyQt5.QtWidgets import QHeaderView,qApp,QDesktopWidget
import PyQt5.QtGui
...
class HomeScreen(QMainWindow):
    def __init__(self):
        ...
        self.btn_home.setStyleSheet("width:200px;height:80px;font-size:20px;background:#8B4C39;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_add.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7D9EC0;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_manage.setStyleSheet("width:200px;height:80px;font-size:20px;background:#8B4C39;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_history.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7D9EC0;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
        ...
        self.frame_1=QFrame()
        self.frame_1.setMinimumWidth(805)#(self.width())
        self.frame_1.setMaximumWidth(805)#(self.width())##this set the width equal to above button there in home page
        self.frame_1.setMaximumHeight(805)#(self.width())
        self.frame_1.setMaximumHeight(805)#(self.width())
        self.frame_1.setLayout(self.vertical_1)

        self.frame_2=QFrame()
        self.frame_2.setMinimumWidth(805)  # (self.width())
        self.frame_2.setMaximumWidth(805)  # (self.width())##this set the width equal to above button there in home page
        self.frame_2.setMaximumHeight(805)  # (self.width())
        self.frame_2.setMaximumHeight(805)  # (self.width())
        ...
        #layout_horizontal.adjustSize()
        parent_vertical.setContentsMargins(0,0,0,0)
        parent_vertical.addStretch(1)
        #menu_vertical_layout.addStretch()
    ...
    def showHistory(self):
        ...
        self.btn_add.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7D9EC0;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_manage.setStyleSheet("width:200px;height:80px;font-size:20px;background:#8B4C39;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_history.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7171C6;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
    ...
    def showManage(self):
        self.btn_home.setStyleSheet("width:200px;height:80px;font-size:20px;background:#8B4C39;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_add.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7D9EC0;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_manage.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7171C6;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_history.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7D9EC0;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
    ...
    def showAdd(self):
        self.btn_home.setStyleSheet("width:200px;height:80px;font-size:20px;background:#8B4C39;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_add.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7171C6;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_manage.setStyleSheet("width:200px;height:80px;font-size:20px;background:#8B4C39;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_history.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7D9EC0;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
    ...
    def showHome(self):
        self.btn_home.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7171C6;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_add.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7D9EC0;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_manage.setStyleSheet("width:200px;height:80px;font-size:20px;background:#8B4C39;color:#7D9EC0;font-weight:bold;border:1px solid white;border-radius:35")
        self.btn_history.setStyleSheet("width:200px;height:80px;font-size:20px;background:#7D9EC0;color:#8B4C39;font-weight:bold;border:1px solid white;border-radius:35")
    ...
    def refreshHome(self):
        ...
        for data in alldata:
            ...
            if data[3]==1:
                label.setStyleSheet("background-color:#A4D3EE;color:#5E2612;padding:5px;width:200px;height:200px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:#CD8162;color:#FCFCFC;padding:5px;width:200px;height:200px;border:1px solid white;text-align:center;font-weight:bold")
    ...
    def addHomePageData(self):
        ...
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#5E2612;border:1px solid white;border-radius:35") ##changing refresh color
        ...
        for data in alldata:
            ...
            if data[3]==1:
                label.setStyleSheet("background-color:#A4D3EE;color:#5E2612;padding:5px;width:100px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:#CD8162;color:#FCFCFC;padding:5px;width:100px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
    ...
    def addAddStudentPage(self):
        ...
        name_label.setStyleSheet("color:#7D9EC0;padding:8px 0px;font-size:20px") ##here we change the font color on add page
        mobile_label=QLabel("Mobile : ")
        mobile_label.setStyleSheet("color:#7D9EC0;padding:8px 0px;font-size:20px")
        vechicle_label=QLabel("Vehicle No : ")
        vechicle_label.setStyleSheet("color:#7D9EC0;padding:8px 0px;font-size:20px")
        vechicle_type=QLabel("Vehicle Type : ")
        vechicle_type.setStyleSheet("color:#7D9EC0;padding:8px 0px;font-size:20px")
        error_label=QLabel("")
        error_label.setStyleSheet("color:red;padding:8px 0px;font-size:20px")

        name_input=QLineEdit()
        name_input.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#8B4C39")
        mobile_input=QLineEdit()
        mobile_input.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#8B4C39")
        vehicle_input=QLineEdit()
        vehicle_input.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#8B4C39")
        vtype=QComboBox()
        vtype.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;border:1px solid white;background:#8B4C39")#here we add bg color bocx of of add page
        vtype.addItem("2 Wheeler")
        vtype.addItem("4 Wheeler")

        button=QPushButton("Add Vehicle")
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#5E2612;border:1px solid white;border-radius:35")
        ...
        frame.setMinimumHeight(805)#(self.height())
        frame.setMinimumWidth(805)#(self.width())
        frame.setMaximumHeight(805)#(self.width())
        frame.setMaximumWidth(805)#(self.width())
    ...
    def addManagePage(self):
        ...
        self.table.setStyleSheet("background:#A4D3EE")
        ...
        for smalldata in data:
            ...
            self.button_exit.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#5E2612;border:1px solid white;border-radius:35")
        ...
        frame.setMaximumWidth(805)#(self.width())
        frame.setMinimumWidth(805)#(self.width())
        frame.setMaximumHeight(805)#(self.height())
        frame.setMinimumHeight(805)#(self.height())
    ...
    def addHistoryPage(self):
        ...
        self.table1.setRowCount(len(data))
        self.table1.setStyleSheet("background:#A4D3EE")
        self.table1.setColumnCount(7)
        ...
        self.frame5.setMaximumWidth(805)#(self.width())
        self.frame5.setMinimumWidth(805)#(self.width())
        self.frame5.setMaximumHeight(805)#(self.height())
        self.frame5.setMinimumHeight(805)#(self.height())
