...
class LoginScreen(QWidget):
    def __init__(self):
        ...
        self.input_username.setStyleSheet("padding:5px;background:#0000FF;color:#F0F8FF;font-size:17px")
        ...
        self.input_password.setStyleSheet("padding:5px;background:#0000FF;color:#F0F8FF;font-size:17px")

        btn_login=QPushButton("Login")
        btn_login.setStyleSheet("padding:5px;font-size:20px;background:#DC143C;border-radius:15px;color:#fff")
